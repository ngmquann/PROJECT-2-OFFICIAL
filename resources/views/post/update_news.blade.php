                    ...
                    <div class="position-center shadow p-4">
                        <form role="form" action="{{ url('post_update_news/' . $edit_p->news_id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="news_content" id="myeditorinstance">{{ $edit_p->news_content }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Image</label><br>
                                <img class="img-fluid" src="{{ url('/images/news_images/' . $edit_p->news_images) }}" /><br>
