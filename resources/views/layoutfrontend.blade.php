            ...
            <nav class="u-menu u-menu-one-level u-offcanvas u-menu-1 nav-menu">
                ...
                <ul id="main-menu">
                    ...
                    @foreach ($cate_edit as $cate_home)
                        <li>
                            <a href="{{ url('/show_category_detail/' . $cate_home->category_id) }}">{{ $cate_home->category_name }}
                            </a>
                            <ul class="sub-menu">
                                @foreach ($brand as $brand_menu)
                                    @if ($brand_menu->category_id == $cate_home->category_id)
                                        <li><a
                                                href="{{ url('/show_category_detail/show_brand_detail/' . $brand_menu->brand_id) }}">{{ $brand_menu->brand_name }}</a>
                                        </li>
                                    @endif
                                @endforeach
                            </ul>
                    ...
                    <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
                        <div class="u-inner-container-layout u-sidenav-overflow">
                            ...
                            <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                                ...
                                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="Page-1.html">Page
                                        1</a>
                                </li>
                                <li class="u-nav-item"><a class="u-button-style u-nav-link">News</a>
                                </li>
                                <li class="u-nav-item"><a class="u-button-style u-nav-link">Shop card</a>
                                </li>
                            </ul>
                        </div>
                    </div>
